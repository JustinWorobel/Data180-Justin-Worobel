...
ggplot(Cars93, aes(x = EngineSize, y = MPG.city)) +
  ...
  xlim(0, max(Cars93$EngineSize) + 1)+
  ylim(0, max(Cars93$MPG.city) + 5)+
         labs(x = "Engine Size", y = "MPG City", subtitle = "using ggplot to visulaize relationship", caption = "Data: Cars93") + 
  ggtitle("Scatterplot of Engine Size vs. MPG City") 
...
# You need to show types or airbag by origin: Driver only, driver and passenger, None by US and non_USA (-2)
```
...
ggplot(Cars93, aes(x = AirBags, fill = AirBags))+
  geom_bar()+
  labs(title = "Car Count by Airbag Type", 
       x = "Airbag Type",
       y = "Count",
       subtitle = "Using ggplot to visualize airbag data",
       caption = "Data: Cars93")
...
ggplot(Cars93, aes(x = Origin, fill = AirBags))+
  ...
  labs(title = "Car Count by Airbag Type Based on Car Origin", 
       x = "Airbag Type",
       y = "Count",
       subtitle = "Using ggplot to visualize airbag data",
       caption = "Data: Cars93")
...
ggplot() +
  geom_sf(data = au_states) +
  geom_point(data = au_capitals, aes(x = c(lon), y = c(lat)), col = "red", size = 2) +
