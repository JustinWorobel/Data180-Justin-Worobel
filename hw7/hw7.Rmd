...
library(tidyverse)
library(tm)
news<-read.csv("/Users/justinworobel/Desktop/Data180-Justin-Worobel/hw7/news.csv",header=T)
...
```{r}
posWords <- scan("/Users/justinworobel/Desktop/Data180-Justin-Worobel/hw7/positive-words.txt", character(0), sep = "\n")  # 2006 items
negWords <- scan("/Users/justinworobel/Desktop/Data180-Justin-Worobel/hw7/negative-words.txt", character(0), sep = "\n")  # 4783 items
head(posWords,15)
head(negWords,15)
```
