...
date: '`r format(Sys.Date(), "9 17, 2023")`'
output: 
  html_document
---

18/20. Your code ran fine but your fibonacci function was incorrect. Good job overall.. 
...
```{r}
my_df = data.frame(people = c("Alice", "Bob", "Charlie", "Denise", "Erin", "Frank", "Gisele", "Harry"), preference = c("Twitter", "Facebook", "Twitter", "Instagram", "Facebook", "Twitter", "Twitter", "Instagram"))
```
...
get_fibonacci(5) # This should return 3 not 5 
